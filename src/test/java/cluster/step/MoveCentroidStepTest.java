...
public class MoveCentroidStepTest {
    ...
    public void testMoveCentroids() {
        ...
        Map<Integer, List<Coordinate>> data_to_centroid = new HashMap<>();
        List<Coordinate> data_for_centroid_one = new ArrayList<>();
        ...
        List<Coordinate> data_for_centroid_two = new ArrayList<>();
        ...
        Map<Integer, Coordinate> result = MoveCentroidStep.moveCentroids(data_to_centroid);
