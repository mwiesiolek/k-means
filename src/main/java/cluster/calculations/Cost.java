...
public class Cost {
    ...
    public static double calculate(Map<Integer, List<Coordinate>> centroid_index_to_data_points, Map<Integer, Coordinate> centroid_index_to_location) {
        double sum = 0;
        ...
        for (Integer index: centroid_indexes) {
            ...
            try {
                ...
                List<Coordinate> data_points_for_centroid = centroid_index_to_data_points.get(index);
