...
public class KMeansGraph {
    ...
    public ScatterChart drawGraph(Map<Integer, List<Coordinate>> data_points, Map<Integer, Coordinate> centroids) {
        ...
        for (Integer centroid_number : data_points.keySet()) {
            ...
            List<Coordinate> dps = data_points.get(centroid_number);
